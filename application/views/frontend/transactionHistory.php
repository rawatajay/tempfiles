                    ...
                    <div class="tbl">
                        <div class="tbl-row">
                            <div class="tbl-cell">
                                ...
                                <a href="<?php echo base_url()?>user/user_TransactionHistory" ><button style="float: right"  type="button" class="btn btn-rounded btn-inline">User Transaction</button></a>
                                <a href="<?php echo base_url()?>user/payu_PaymentHistory" ><button style="float: right"  type="button" class="btn btn-rounded btn-inline">Payu Transaction</button></a>
                                </h2>
                            </div>
                        </div>
                    </div>
