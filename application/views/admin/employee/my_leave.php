    ...
    <div class="container-fluid">
        ...
        <section class="card">
			<div class="card-block">
            	...
            	<table id="myleavelist" class="display table table-striped table-bordered" cellspacing="0" width="100%" >
					<thead>
						<tr>
							<th>Name</th>
							<th>EmpId</th>
						...
						<tr>
							...
							<td> 
								...
								<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
									<button data-toggle="tooltip" data-original-title="Edit" type="button" class="btn btn-primary-outline" onclick="window.location.href='<?php echo base_url('employee/edit_leave/').'/'.encrypt_decrypt('encrypt',$val['leaveid'])?>'">
