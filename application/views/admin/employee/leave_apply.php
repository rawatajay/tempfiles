<div class="page-content" >
    <div class="container-fluid">
        ...
        <div class="row">
            <section class="box-typical" ng-controller="LeaveController">
									...
									<form id="leaveform" name="form-signup_v1" method="POST"  >
										...
										<div class="form-group">
											...
											<div class="form-control-wrapper">
												...
												<option ng-selected= "{{value.id == tempEmpData.leaveTypes}}" ng-repeat="value in leaveTypes"  value="{{value.id}}">{{value.value}}     
												</option>
												</select> 
										...
										<div class="form-group">
											<button type="button" ng-click="applyleave('save')" class="btn applyleave-btn">Apply Leave</button>
										</div>
									</form>
								</div>
							</div><!--.row-->
