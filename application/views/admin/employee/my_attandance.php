        ...
        <section class="card">
			<div class="card-block">
            	...
            	<form class="form-inline">
					...
					<button type="button" class="btn btn-default getemployeemonthlyattandance">GET MONTHLY ATTANDANCE</button>
				</form><br>
				<table id="employeeAttandanceDatable" class="display table table-striped table-bordered" width="100%" cellspacing="0">
			        <thead>
			            <tr>
			                <th>EmpCode</th>
							<th>Name</th>
