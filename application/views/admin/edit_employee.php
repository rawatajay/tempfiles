		                    		...
		                    		<div class="row m-t-lg">								
										<div class="col-md-6">
											...
											<form id="form-signup_v1" name="form-signup_v1" method="POST" >
												...
												<div class="form-group">
													<button type="button" ng-click="saveEmployee()" class="btn signup-personal-btn">Sign up!</button>
												</div>
											</form>
										</div>
									</div><!--.row-->
		                        ...
		                        <div class="col-xl-12">
		                    		<div class="row m-t-lg">								
										<div class="col-md-6">
											...
											<form id="form-signup_v1" name="form-signup_v1" method="POST" >
												<div class="form-group">
													<label class="form-label" for="signup_v1-empid">Employee ID</label>
													<div class="form-control-wrapper">
												...
												<div class="form-group">
													...
													<button type="button" ng-click="updateHrInfo()" class="btn signup-hrinfo-btn">Update Info</button>
												</div>
											</form>
										</div>
									</div><!--.row-->
		                    		...
		                    		<div class="row m-t-lg">								
										<div class="col-md-6">
											...
											<form id="form-signup_v1" name="form-signup_v1" method="POST" >
												...
												<div class="form-group">
													<input type="hidden" ng-model="tempEmpData.primary">
													<button type="button" ng-click="updateAccountInfo()" class="btn signup-accinfo-btn">Update Info</button>
												</div>
											</form>
										</div>
									</div><!--.row-->
